...
|-----------|-------------|---------|
| NATAL | Start from natal rashi | D5-D6, D8, D11-D12, D15, D18, D21-D22, D25, D28, D36, D48, D50, D54, D72, D81, D108, D144 |
...
| MODALITY_FIXED | Chara → Mesha(0), Sthira → Simha(4), Dviswabhava → Dhanu(8) | D16, D45 |
| MODALITY_SHIFTED | Chara → Mesha(0), Sthira → Dhanu(8), Dviswabhava → Simha(4) | D20 |
| ODD_EVEN_FIXED_START | Odd → Simha(4), Even → Karka(3) | D24 |
| ODD_EVEN_FIXED_START_ALT | Odd → Mesha(0), Even → Tula(6) | D40 |
| D30_SEGMENTS | Odd/even signs use unequal Trimshamsha segment tables | D30 |

### Progression

- **Sequential** (+1 mod 12): All amshas except D3 and D4
- **Kendra** (+3 mod 12): D4 (Chaturthamsha)
