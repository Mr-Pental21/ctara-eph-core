...
use super::kaal_chakra_data::{
    ALL_DPS, KCD_DEFAULT_METHOD, KCD_NAKSHATRA_PADA_MAP, KCD_RASHIS_PER_DP, KCD_RASHI_YEARS,
...
mod tests {
    ...
    fn kaal_chakra_children_12_rashis() {
        let periods = kaal_chakra_level0(BIRTH_JD, 0.0);
        let children =
            kaal_chakra_children(&periods[0], super::super::variation::SubPeriodMethod::ProportionalFromParent);
