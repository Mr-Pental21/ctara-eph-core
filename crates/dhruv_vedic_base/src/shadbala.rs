...
pub fn nathonnatha_bala_at_local_day_fraction(graha: Graha, local_day_fraction: f64) -> f64 {
    ...
    let surya_shukra_guru_group =
        matches!(graha, Graha::Surya | Graha::Shukra | Graha::Guru);
...
mod tests {
    ...
    fn nathonnatha_midnight_to_midday_ramp() {
        ...
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Surya, fraction) - 20.0).abs() < EPS);
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Guru, fraction) - 20.0).abs() < EPS);
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Mangal, fraction) - 40.0).abs() < EPS);
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Shani, fraction) - 40.0).abs() < EPS);
    }
    ...
    fn nathonnatha_midday_to_midnight_ramp() {
        ...
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Surya, fraction) - 40.0).abs() < EPS);
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Shukra, fraction) - 40.0).abs() < EPS);
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Chandra, fraction) - 20.0).abs() < EPS);
        assert!((nathonnatha_bala_at_local_day_fraction(Graha::Mangal, fraction) - 20.0).abs() < EPS);
    }
    ...
    fn nathonnatha_buddh_always_sixty() {
        for fraction in [0.0, 0.25, 0.5, 0.75, 0.99] {
            assert!(
                (nathonnatha_bala_at_local_day_fraction(Graha::Buddh, fraction) - 60.0).abs()
                    < EPS
            );
        }
    }
